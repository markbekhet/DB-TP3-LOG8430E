...
./bin/ycsb load redis -s -P workloads/workloadb -p "redis.host=127.0.0.1" -p "redis.port=6379" -p "redis.clustert=true" >> ../redis/outputLoad.txt
printf "\n##################################################################################\n" >> ../redis/outputRun.txt
printf "Running test workoad b \n" >> ../redis/outputRun.txt
./bin/ycsb run redis -s -P workloads/workloadb -p "redis.host=127.0.0.1" -p "redis.port=6379" -p "redis.clustert=true" >> ../redis/outputRun.txt

printf "\n##################################################################################\n" >> ../redis/outputLoad.txt 
printf "Loading data worload c \n" >> ../redis/outputLoad.txt 
./bin/ycsb load redis -s -P workloads/workloadc -p "redis.host=127.0.0.1" -p "redis.port=6379" -p "redis.clustert=true" >> ../redis/outputLoad.txt
printf "\n##################################################################################\n" >> ../redis/outputRun.txt
printf "Running test workoad c \n" >> ../redis/outputRun.txt
./bin/ycsb run redis -s -P workloads/workloadac -p "redis.host=127.0.0.1" -p "redis.port=6379" -p "redis.clustert=true" >> ../redis/outputRun.txt

printf "\n##################################################################################\n" >> ../redis/outputLoad.txt 
printf "Loading data worload d \n" >> ../redis/outputLoad.txt 
./bin/ycsb load redis -s -P workloads/workloadd -p "redis.host=127.0.0.1" -p "redis.port=6379" -p "redis.clustert=true" >> ../redis/outputLoad.txt
printf "\n##################################################################################\n" >> ../redis/outputRun.txt
printf "Running test workoad d \n" >> ../redis/outputRun.txt
./bin/ycsb run redis -s -P workloads/workloadd -p "redis.host=127.0.0.1" -p "redis.port=6379" -p "redis.clustert=true" >> ../redis/outputRun.txt

printf "\n##################################################################################\n" >> ../redis/outputLoad.txt
printf "Loading data worload e \n" >> ../redis/outputLoad.txt 
./bin/ycsb load redis -s -P workloads/workloade -p "redis.host=127.0.0.1" -p "redis.port=6379" -p "redis.clustert=true" >> ../redis/outputLoad.txt
printf "\n##################################################################################\n" >> ../redis/outputRun.txt
...
./bin/ycsb load redis -s -P workloads/workloadf -p "redis.host=127.0.0.1" -p "redis.port=6379" -p "redis.clustert=true" >> ../redis/outputLoad.txt
printf "\n##################################################################################\n" >> ../redis/outputRun.txt
printf "Running test workoad f \n" >> ../redis/outputRun.txt
./bin/ycsb run redis -s -P workloads/workloadf -p "redis.host=127.0.0.1" -p "redis.port=6379" -p "redis.clustert=true" >> ../redis/outputRun.txt
